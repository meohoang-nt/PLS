...
namespace GUI
{
    public partial class r_chitietpchi : DevExpress.XtraReports.UI.XtraReport
    { 
        public r_chitietpchi()
        {
            InitializeComponent();
            LanguageHelper.Translate(this);
            changeFont.Translate(this);

            tran_rp.tran7(txtkho, txtloai, txtdoituong, txtcongviec, txtmuccp, txttime, ngay2, xrPageInfo2);
