...
{
    public partial class f_chitietnhapkho : Form
    {
        KetNoiDBDataContext db = new KetNoiDBDataContext();
        Boolean doubleclick1 = false;
        Boolean doubleclick2 = false;

        public f_chitietnhapkho()
        {
            InitializeComponent();
        ...
        private void f_chitietnhapkho_Load(object sender, EventArgs e)
        {
            ...
            this.Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "BÁO CÁO NHẬP KHO").ToString();
        ...
        private void danhmuc_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (danhmuc.Text == "Đối Tượng Cung Cấp - ເປົ້າໝາຍຜູ້ສະໜອງ")
            {
                try
                {
            ...
            else if (danhmuc.Text == "Loại Nhập - ປະເພດການນຳເຂົ້າ")
            {
                try
                {

                    var lst = (from a in db.dmpnhaps select new { id = a.danhmuc, name = a.danhmuc_l == null ? "---" : a.danhmuc_l, key = Biencucbo.donvi + a.danhmuc + Biencucbo.idnv });
                    nguon.DataSource = lst;
        ...
        private void simpleButton5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < gridView2.DataRowCount; i++)
                {
                    ...
                    else if (gridView2.GetRowCellValue(i, "loai").ToString() == "Đối Tượng Cung Cấp - ເປົ້າໝາຍຜູ້ສະໜອງ")
                    {
                        check2++;
                    ...
                    else if (gridView2.GetRowCellValue(i, "loai").ToString() == "Loại Nhập - ປະເພດການນຳເຂົ້າ")
                    {
                        check4++;
                ...
                else
                {
                    ...
                    var lst2 = from a in db.r_pnhaps join b in db.dk_rps on a.iddv equals b.id
                    ...
                    if (check4 != 0)
                    {
                        lst6 = from a in lst5 join b in db.dk_rps on a.loainhap equals b.id
                               where b.user == Biencucbo.idnv
                               select a;
                    }
                    else
                    ...
                    var lst = from a in lst6
                              where a.ngaynhap >= DateTime.Parse(tungay.Text) && a.ngaynhap <= DateTime.Parse(denngay.Text)
                              select a;



                    //r_chitietnhapkho xtra = new r_chitietnhapkho();
                    r_chitietnhapkho2 xtra = new r_chitietnhapkho2();
                    xtra.DataSource = lst;
