...
{
    public partial class f_ctcnkh_bak : Form
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var lstton1 = from a in db.r_pxuats
                                  ...
                                  where a.ngayhd < tungay.DateTime && (a.loaixuat == "Xuất bán - ຈ່າຍອອກຂາຍ" || a.loaixuat == "Xuất Khác - ເບີກຈ່າຍອື່ນໆ") &&  b.user == Biencucbo.idnv
                                  select a;
                    if (check2 != 0)
                    {
                    ...
                    var lstton3 = from a in db.r_pthus
                                  join b in db.dk_rps on a.iddv equals b.id
                                  where a.ngaythu < tungay.DateTime && (a.loaithu == "Thu tiền bán hàng - ຮັບເງິນຂາຍສິນຄ້າ" || a.loaithu == "Thu tiền Nợ - ຮັບເງິນໜີ້") && b.user == Biencucbo.idnv
                                  select a;
                    if (check2 != 0)
                    {
