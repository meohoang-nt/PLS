...
namespace GUI
{
    public partial class f_pcantru : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        KetNoiDBDataContext db = new KetNoiDBDataContext();
        t_pcantru pcantru = new t_pcantru();
        ...
        public f_pcantru()
        {
            ...
            txtdttruno.Properties.DataSource = new DAL.KetNoiDBDataContext().doituongs;
            txtdtcantru.Properties.DataSource = new DAL.KetNoiDBDataContext().doituongs;
            try
            {
        ...
        public void load()
        {
            ...
            txtdttruno.ReadOnly = true;
            txtdtcantru.ReadOnly = true;
            txtch.ReadOnly = true;
            ...
            try
            {
                var lst = (from a in db.pcantrus where a.iddv == Biencucbo.donvi select a.so).Max();
                var lst1 = (from b in db.pcantrus where b.iddv == Biencucbo.donvi select b).FirstOrDefault(t => t.so == lst);
                if (lst1 == null) return;

                gcchitiet.DataSource = lst1.pcantructs;

                txtid.Text = lst1.id;

                txtidnv.Text = lst1.idnv;
                txtdv.Text = lst1.iddv;
                txtngaynhap.DateTime = DateTime.Parse(lst1.ngayct.ToString());
                txtdttruno.Text = lst1.dttruno;
                txtdtcantru.Text = lst1.dtcantru;
                try
                {
                    var lstdt = (from a in db.doituongs select a);
                    lbldtcantru.Text = lstdt.Single(t => t.id == txtdtcantru.Text).id;
                    lbldttruno.Text = lstdt.Single(t => t.id == txtdttruno.Text).id;
                }
                catch
                {
        ...
        {
            db = new KetNoiDBDataContext();
            f_dspcantru frm = new f_dspcantru();
            frm.ShowDialog();
            if (Biencucbo.getID == 1)
            {
                ...
                try
                {
                    var lst = (from pn in db.pcantrus select new { a = pn }).FirstOrDefault(x => x.a.id == Biencucbo.ma);
                    ...
                    txtngaynhap.DateTime = DateTime.Parse(lst.a.ngayct.ToString());
                    txtdttruno.Text = lst.a.dttruno;
                    txtdtcantru.Text = lst.a.dtcantru;
                    try
                    {
                        var lstdt = (from a in db.doituongs select a);
                        lbldtcantru.Text = lstdt.Single(t => t.id == txtdtcantru.Text).id;
                    ...
                    gcchitiet.DataSource = lst.a.pcantructs;
        ...
        private void btnnew_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            gcchitiet.DataSource = new DAL.KetNoiDBDataContext().View_pcantrus;
            ...
            txtdttruno.ReadOnly = false;
            txtdtcantru.ReadOnly = false;
        ...
        public void luu()
        {
            ...
            if (txtngaynhap.Text == "" || txtdttruno.Text == "" || txtdtcantru.Text == "" || txttiente.Text == "" || txttygia.Text == "" || txtch.Text == "")
            {
            ...
            else
            {
                if (Biencucbo.hdpt == 0)
                {
                    ...
                    try
                    {
                        string check = "PCTCN" + Biencucbo.donvi.Trim().ToString();
                        ...
                        pcantru.moipcantru(txtid.Text, txtngaynhap.DateTime, txtdttruno.Text, txtdtcantru.Text, txtdv.Text, txtidnv.Text, txtghichu.Text, Convert.ToInt32(txt1.Text), txtch.Text, txttiente.Text, double.Parse(txttygia.Text));
                        // History
                        //hs.add(txtid.Text, "Thêm mới chứng từ - ເພີ່ມເອກະສານໃໝ່ - ERROR");

                        for (int i = 0; i <= gridView1.RowCount - 1; i++)
                        {
                            gridView1.SetRowCellValue(i, "idcantru", txtid.Text);
                            gridView1.SetRowCellValue(i, "id", txtid.Text + i);

                            pcantru.moict(gridView1.GetRowCellValue(i, "diengiai").ToString(), gridView1.GetRowCellValue(i, "idcv").ToString(), gridView1.GetRowCellValue(i, "idmuccp").ToString(), double.Parse(gridView1.GetRowCellValue(i, "thanhtien").ToString()), gridView1.GetRowCellValue(i, "idcantru").ToString(), gridView1.GetRowCellValue(i, "id").ToString(), double.Parse(gridView1.GetRowCellValue(i, "nguyente").ToString())/*, gridView1.GetRowCellValue(i, "tkco").ToString()*/);
                        }
                        // History
                ...
                else
                {
                    try
                    {
                        pcantru.suapt(txtid.Text, DateTime.Parse(txtngaynhap.Text), txtdttruno.Text, txtdtcantru.Text, txtghichu.Text, int.Parse(txt1.Text), txtch.Text, txttiente.Text, double.Parse(txttygia.Text));
        ...
        private void btnsua_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                var lst = (from pn in db.pcantrus select pn).FirstOrDefault(x => x.id == txtid.Text);
                if (lst == null) return;
                ...
                txttygia.ReadOnly = true;
                gcchitiet.DataSource = lst.pcantructs;
                gridView1.OptionsBehavior.Editable = true;
        ...
        private void btnxoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (XtraMessageBox.Show("Bạn có chắc chắn muốn xóa Phiếu " + txtid.Text + " không?", "THÔNG BÁO", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    {
                        pcantru.xoact(gridView1.GetRowCellValue(i, "id").ToString());
                        gridView1.DeleteRow(i);
                    }
                    pcantru.xoapcantru(txtid.Text);
        ...
        private void btnload_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (Biencucbo.hdpt == 1)
            {
                ...
                txtdv.Text = lst.iddv;
                txtngaynhap.DateTime = DateTime.Parse(lst.ngayct.ToString());
                txtdttruno.Text = lst.dttruno;
                txtdtcantru.Text = lst.dtcantru;
                try
                {
                    var lstdt = (from a in db.doituongs select a);
                    lbldtcantru.Text = lstdt.Single(t => t.id == txtdtcantru.Text).id;
        ...
        private void gridView1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (e.KeyCode == Keys.Delete)
            {
                if (Biencucbo.hdpt == 1)
                {
                    try
                    {
                        pcantruct ct = (from c in db.pcantructs select c).Single(x => x.id == gridView1.GetFocusedRowCellValue("id").ToString());
        ...
        private void txtiddt_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                var lst = (from a in db.doituongs select a).Single(t => t.id == txtdttruno.Text);
                lbldttruno.Text = lst.ten.ToString();
        ...
        private void gridView1_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            if (Biencucbo.hdpt == 1)
            {
                var ct = gridView1.GetFocusedRow() as pcantruct;
                if (ct == null) return;
        ...
        private void btnin_ItemClick_1(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                //var lst = (from a in db.r_pcantrus where a.id == txtid.Text select a);
                //r_pcantru xtra = new r_pcantru();
                //xtra.DataSource = lst;
        ...
        private void btnPrev_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    var lst = (from pn in db.pcantrus select new { a = pn }).FirstOrDefault(x => x.a.iddv == Biencucbo.donvi && x.a.ngayct == (txtngaynhap.DateTime.AddDays(-1)));
                    if (lst == null)
                    {
                        lst = (from pn in db.pcantrus select new { a = pn }).OrderByDescending(x => x.a.ngayct).FirstOrDefault(x => x.a.iddv == Biencucbo.donvi && x.a.ngayct < txtngaynhap.DateTime);
                    }
                    txtid.Text = lst.a.id;
                    txtidnv.Text = lst.a.idnv;
                    txtdv.Text = lst.a.iddv;
        ...
        private void btnNext_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (lst == null)
                    {
                        lst = (from pn in db.pcantrus select new { a = pn }).OrderBy(x => x.a.ngayct).FirstOrDefault(x => x.a.iddv == Biencucbo.donvi && x.a.ngayct > txtngaynhap.DateTime);
                    }
                    txtid.Text = lst.a.id;
                    txtidnv.Text = lst.a.idnv;
                    txtdv.Text = lst.a.iddv;
        ...
        private void txtdtcantru_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                var lst = (from a in db.doituongs select a).Single(t => t.id == txtdtcantru.Text);
                lbldtcantru.Text = lst.ten.ToString();
        ...
        private void f_pcantru_Load(object sender, EventArgs e)
        {
            LanguageHelper.Translate(this);
            LanguageHelper.Translate(barManager1);
            this.Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Phiếu Cấn Trừ Công Nợ").ToString();
