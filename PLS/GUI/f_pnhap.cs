...
namespace GUI
{
    public partial class f_pnhap : DevExpress.XtraBars.Ribbon.RibbonForm
    {
                ...
                else
                {
                    if (Biencucbo.hdpn == 0)
                    {
                        ...
                        try
                        {
                            ...
                            pnct.moipn(txtid.Text, txtngaynhap.DateTime, txtiddt.Text, txtdv.Text, txtidnv.Text, txtghichu.Text, Convert.ToInt32(txt1.Text), txtloainhap.Text, "KIP", 1);
                            // History 
                    ...
                    else
                    {
                        try
                        {
                            pnct.suapn(txtid.Text, DateTime.Parse(txtngaynhap.Text), txtiddt.Text, txtghichu.Text, int.Parse(txt1.Text), txtloainhap.Text, "KIP", 1);
        ...
        private void gridView1_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if (e.Column.FieldName == "vhd" || e.Column.FieldName == "vtt" || e.Column.FieldName == "tn" ||
                e.Column.FieldName == "tx" || e.Column.FieldName == "idsanpham" || e.Column.FieldName == "tb")
            {
                double beta = 0;
                try
                {
                    ...
                    double nhietdo_be = 0;
                    nhietdo_be = double.Parse(gridView1.GetFocusedRowCellValue("tb").ToString());
                    ...
                    else
                    {
                        ...
                        //gridView1.SetFocusedRowCellValue("soluongcl", double.Parse(gridView1.GetFocusedRowCellValue("soluong").ToString()) * beta * (double.Parse(txttch.Text) - double.Parse(gridView1.GetFocusedRowCellValue("tx").ToString())));

                        gridView1.SetFocusedRowCellValue("soluongcl", double.Parse(gridView1.GetFocusedRowCellValue("soluong").ToString()) * beta * (nhietdo_be - double.Parse(gridView1.GetFocusedRowCellValue("tx").ToString())));
                    }
                }
                catch (Exception ex)
                {
            ...
            if (e.Column.FieldName == "soluong" || e.Column.FieldName == "dongia" || e.Column.FieldName == "chietkhau" || e.Column.FieldName == "loaithue" || e.Column.FieldName == "tygia")
            {
                ...
                try
                {
                    try
                    {
                        gridView1.SetFocusedRowCellValue("thue", (((float.Parse(gridView1.GetFocusedRowCellValue("soluong").ToString())) * (float.Parse(gridView1.GetFocusedRowCellValue("dongia").ToString()))) - ((float.Parse(gridView1.GetFocusedRowCellValue("soluong").ToString())) * (float.Parse(gridView1.GetFocusedRowCellValue("chietkhau").ToString())))) * float.Parse(gridView1.GetFocusedRowCellDisplayText("loaithue").ToString()) / 100);
                    }
                    catch
                    {

                        gridView1.SetFocusedRowCellValue("nguyente", (((float.Parse(gridView1.GetFocusedRowCellValue("soluong").ToString())) * (float.Parse(gridView1.GetFocusedRowCellValue("dongia").ToString()))) - ((float.Parse(gridView1.GetFocusedRowCellValue("soluong").ToString())) * (float.Parse(gridView1.GetFocusedRowCellValue("chietkhau").ToString())))) + float.Parse(gridView1.GetFocusedRowCellValue("thue").ToString()));
                    }
                    finally
                    {
                        gridView1.SetFocusedRowCellValue("thue", (((float.Parse(gridView1.GetFocusedRowCellValue("soluong").ToString())) * (float.Parse(gridView1.GetFocusedRowCellValue("dongia").ToString()))) - ((float.Parse(gridView1.GetFocusedRowCellValue("soluong").ToString())) * (float.Parse(gridView1.GetFocusedRowCellValue("chietkhau").ToString())))) * float.Parse(gridView1.GetFocusedRowCellDisplayText("loaithue").ToString()) / 100);
        ...
        private void gridView1_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            ...
            else
            {
                ...
                gridView1.SetFocusedRowCellValue("tb", 0);
                gridView1.SetFocusedRowCellValue("soluongcl", 0);
