...
namespace GUI
{
    public partial class f_pchi : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public f_pchi()
        {
            ...
            var lst0 = from a in db.dmpchis where a.danhmuc != "Nộp Tiền Chi Nhánh - ມອບເງິນໃຫ້ສາຂາ" && a.danhmuc != "Chi phí nội bộ - ຄ່າໃຊ່ຈ່າຍພາຍໃນ" select a;
        ...
        private void f_pchi_Load(object sender, EventArgs e)
        {
            ...
            this.Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Phiếu Chi Tiền").ToString();
