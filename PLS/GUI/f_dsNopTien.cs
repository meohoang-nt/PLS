...
namespace GUI
{
    ...
    public partial class f_dsNopTien : Form
    {
        ...
        public void loaddata(DateTime tungay, DateTime denngay)
        {
            ...
            var lst = from a in db.r_pchis
                      ...
                      where
                      a.ngaychi >= tungay && a.ngaychi <= denngay && a.dv == Biencucbo.tien
                      && a.loaichi == "Nộp Tiền Chi Nhánh - ມອບເງິນໃຫ້ສາຂາ"
        ...
        private void f_PN_Load(object sender, EventArgs e)
        {
            ...
            this.Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Danh Sách Nộp Tiền Cho Chi Nhánh").ToString();
