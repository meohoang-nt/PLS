...
namespace GUI
{
    public partial class f_hd_khachno : Form
    {
        ...
        public f_hd_khachno()
        {
            ...
            //lay quyen
            var quyen1 = db.PhanQuyen2s.FirstOrDefault(p => p.TaiKhoan == Biencucbo.phongban && p.ChucNang == "HoaDonKhachNo_ThanhToan");
                ...
                else
                {
                    if (Biencucbo.hdhd == 0)
                    {
                        ...
                        try
                        {
                            ...
                            hd.moihd2(txtid.Text, txtngaylap.DateTime, txtiddt.Text, txtidnv.Text, txtdv.Text, txtghichu.Text, Convert.ToInt32(txt1.Text), txtloaihd.Text, txttiente.Text, double.Parse(txttygia.Text), txtidchotct.Text, "0", txtvat.Text);
                            // History 
        ...
        private void f_hd_Load(object sender, EventArgs e)
        {
            ...
            this.Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Hoá Đơn Bán Hàng Kiếm Xuất Kho").ToString();
